...
def register():
    ...
    if form.validate_on_submit():
        if db.get_user_by_username(form.username.data):
            ...
            role_map = {'buyer': UserRole.BUYER, 'seller': UserRole.SELLER,
...
# ---------------------------------------------------------------------------
# BOOKMARK  (add / remove / update notes)
# ---------------------------------------------------------------------------
...
def bookmarks():
    ...
    items     = [(bm, props_map[bm.property_id])
                 for bm in bms if bm.property_id in props_map]
...
# ---------------------------------------------------------------------------
# LISTINGS MANAGEMENT  (seller + admin)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# ENQUIRY MANAGEMENT  (seller/admin view)
# ---------------------------------------------------------------------------
...
def listing_enquiries(property_id):
    ...
    return render_template('enquiries.html', prop=prop,
                           enquiries=enquiries, buyers=buyers,
...
# ---------------------------------------------------------------------------
# OFFER MANAGEMENT  (seller/admin view)
# ---------------------------------------------------------------------------
...
def listing_offers(property_id):
    ...
    return render_template('offers.html', prop=prop,
                           offers=offers, buyers=buyers,
